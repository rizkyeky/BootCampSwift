...
extension WelcomePanelViewController {
    func setupAppleButton() {
        ...
        let appleLogo = SVGIcon.apple.getImage().reColor(.label)
...
extension WelcomePanelViewController {
    func setupGoogleButton() {
        ...
        let googleLogo = SVGIcon.google.getImage().reColor(.label)
...
extension WelcomePanelViewController {
    func setupEmailButton() {
        ...
        let emailLogo = SVGIcon.email.getImage().reColor(.label)
