...
class TextButton: UIButton {
    ...
    convenience init(withTitle: String? = nil, icon: UIImage? = nil, size: CGSize? = nil, iconSize: CGSize? = nil, onTap: (() -> Void)? = nil) {
        ...
        self.init(title: withTitle ?? "", isBold: true, icon: icon, iconSize: iconSize, foregroundColor: AppColor.accent ?? .label, backgroundColor: .clear, frame: frame, tintForegroundColor: AppColor.accent?.withAlphaComponent(0.1))
